...
public class Scene3D : Scene
{
    ...
    public override void Initialize()
    {
        Graphics.Renderer3D.Skybox = new Cubemap(
            new Bitmap("/home/aqua/Pictures/skybox/right.jpg"),
            new Bitmap("/home/aqua/Pictures/skybox/left.jpg"),
            new Bitmap("/home/aqua/Pictures/skybox/top.jpg"),
            new Bitmap("/home/aqua/Pictures/skybox/bottom.jpg"),
            new Bitmap("/home/aqua/Pictures/skybox/front.jpg"),
            new Bitmap("/home/aqua/Pictures/skybox/back.jpg"));
        ...
        MaterialDescription matDesc = new MaterialDescription(new Texture("/home/aqua/Downloads/metalgrid2-dx/metalgrid2_basecolor.png"))
        {
            Normal = new Texture("/home/aqua/Downloads/metalgrid2-dx/metalgrid2_normal-dx.png"),
            Metallic = new Texture("/home/aqua/Downloads/metalgrid2-dx/metalgrid2_metallic.png"),
            Roughness = new Texture("/home/aqua/Downloads/metalgrid2-dx/metalgrid2_roughness.png"),
            Occlusion = new Texture("/home/aqua/Downloads/metalgrid2-dx/metalgrid2_AO.png")
        };
